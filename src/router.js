        ...
        if (docType) {
          ...
          try {
            ...
            const structurePrompt = docType === 'pptx'
              ? `El usuario pidió: "${text}"\n\n${styleGuide}\n\nGenera una presentación PowerPoint corporativa y profesional con 8-12 slides. Responde SOLO con JSON válido:\n{"title":"...","subtitle":"tagline o descripción breve del tema en máximo 12 palabras","author":"nombre del autor si el usuario lo menciona, si no omite este campo","style":"visual|technical|clean","use_images":false,"slides":[{"type":"content","title":"...","points":["**Término clave:** descripción completa con datos concretos","**Otro concepto:** desarrollo del subtema con cifras","Punto sin negrita con contexto adicional","**Impacto:** resultado o consecuencia medible"]},{"type":"section_divider","title":"NOMBRE DE SECCIÓN","subtitle":"descripción breve de lo que cubre esta sección"},{"type":"kpi_slide","title":"Indicadores Clave","kpis":[{"value":"94%","label":"Satisfacción del cliente","delta":"+18%"},{"value":"$2.4M","label":"Ingresos anuales","delta":"+32%"},{"value":"1,240","label":"Usuarios activos","delta":"+15%"},{"value":"4.8/5","label":"Puntuación NPS","delta":"+0.6"}]},{"type":"two_column","title":"...","left":"Párrafo de contexto o análisis en la columna izquierda con mínimo 40 palabras explicando el tema en profundidad.","right_points":["**Punto 1:** descripción con dato","**Punto 2:** descripción con dato","**Punto 3:** descripción con dato"]},{"type":"content","title":"...","table":{"headers":["Col1","Col2","Col3"],"rows":[["dato","dato","dato"],["dato","dato","dato"]]}},{"type":"content","title":"...","flowchart":{"steps":["Inicio","Paso 1: descripción","¿Condición?","Resultado A","Fin"],"decision_idx":2},"curiosity":"¿Sabías que...? dato fascinante"}],"references":[{"author":"Apellido, N.","year":2023,"title":"Título del trabajo","publisher":"Editorial o Revista","url":"https://ejemplo.com"}]}\n\nESTRUCTURA OBLIGATORIA (en este orden aproximado):\n1. Slide de contenido (introducción)\n2. Slide section_divider (primera sección)\n3-4. Slides de contenido con points usando **negrita** para términos\n5. Slide kpi_slide con 4 KPIs reales y relevantes al tema\n6. Slide section_divider (segunda sección)\n7-8. Slides de contenido (uno puede tener table, otro flowchart)\n9. Slide two_column\n10. Slide section_divider (tercera sección, si hay)\n11-12. Slides finales de contenido o two_column\n\nREGLAS:\n- Total: 8-12 slides, exactamente 2-3 section_divider, exactamente 1 kpi_slide, 1-2 two_column\n- Slides de contenido: 4-6 points con **negrita** para términos clave\n- Añade "table" en exactamente 1 slide de contenido con datos comparativos\n- Añade "flowchart" en exactamente 1 slide de contenido (NO el mismo que tiene table)\n- Añade "curiosity" en 2-3 slides de contenido\n- Los section_divider NO llevan points ni table ni flowchart\n- El kpi_slide NO lleva points — solo kpis[]\n- Incluye 3-5 referencias en "references"`
            ...
            const docOpts = {
              style: structure.style || 'clean',
              useImages: !!structure.use_images,
